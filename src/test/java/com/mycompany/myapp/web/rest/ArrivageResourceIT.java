...
class ArrivageResourceIT {
    ...
    void createArrivage() throws Exception {
        ...
        // Create the Arrivage
        restArrivageMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(arrivage)))
    ...
    void putNewArrivage() throws Exception {
        ...
        restArrivageMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedArrivage.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(updatedArrivage))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingArrivage() throws Exception {
        ...
        restArrivageMockMvc
            .perform(
                put(ENTITY_API_URL_ID, arrivage.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(arrivage))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamArrivage() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restArrivageMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(arrivage)))
    ...
    void patchNonExistingArrivage() throws Exception {
        ...
        restArrivageMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, arrivage.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(arrivage))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamArrivage() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restArrivageMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(arrivage)))
            .andExpect(status().isMethodNotAllowed());
