...
class LocationResourceIT {
    ...
    void putNewLocation() throws Exception {
        ...
        updatedLocation.rueAddress(UPDATED_RUE_ADDRESS).codePostal(UPDATED_CODE_POSTAL).ville(UPDATED_VILLE).province(UPDATED_PROVINCE);
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.rueAddress(UPDATED_RUE_ADDRESS).ville(UPDATED_VILLE).province(UPDATED_PROVINCE);
