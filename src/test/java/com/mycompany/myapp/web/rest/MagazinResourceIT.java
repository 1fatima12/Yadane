...
class MagazinResourceIT {
    ...
    void createMagazin() throws Exception {
        ...
        // Create the Magazin
        restMagazinMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(magazin)))
    ...
    void putWithMissingIdPathParamMagazin() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restMagazinMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(magazin)))
    ...
    void patchWithMissingIdPathParamMagazin() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restMagazinMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(magazin)))
            .andExpect(status().isMethodNotAllowed());
