...
export const CategorieDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="electroYadaneVfApp.categorie.delete.question">
        <Translate contentKey="electroYadaneVfApp.categorie.delete.question" interpolate={{ id: categorieEntity.id }}>
