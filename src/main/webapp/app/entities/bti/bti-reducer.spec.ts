...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bti.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BTI_LIST actions', async () => {
    ...
    it('dispatches FETCH_BTI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BTI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BTI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BTI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BTI actions', async () => {
      const expectedActions = [
        {
