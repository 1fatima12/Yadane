...
export const ProduitDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="electroYadaneVfApp.produit.delete.question">
        <Translate contentKey="electroYadaneVfApp.produit.delete.question" interpolate={{ id: produitEntity.id }}>
