...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './magazin.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MAGAZIN_LIST actions', async () => {
    ...
    it('dispatches FETCH_MAGAZIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MAGAZIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MAGAZIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MAGAZIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MAGAZIN actions', async () => {
      const expectedActions = [
        {
