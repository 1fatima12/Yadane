...
export const LocationDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="electroYadaneVfApp.location.delete.question">
        <Translate contentKey="electroYadaneVfApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
