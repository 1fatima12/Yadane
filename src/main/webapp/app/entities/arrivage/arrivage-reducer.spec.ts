...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './arrivage.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARRIVAGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ARRIVAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ARRIVAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ARRIVAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ARRIVAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ARRIVAGE actions', async () => {
      const expectedActions = [
        {
