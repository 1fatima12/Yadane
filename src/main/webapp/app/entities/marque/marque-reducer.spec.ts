...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './marque.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MARQUE_LIST actions', async () => {
    ...
    it('dispatches FETCH_MARQUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MARQUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MARQUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MARQUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MARQUE actions', async () => {
      const expectedActions = [
        {
