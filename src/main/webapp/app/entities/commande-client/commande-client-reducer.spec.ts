...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMMANDECLIENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMMANDECLIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMMANDECLIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMMANDECLIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMMANDECLIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMMANDECLIENT actions', async () => {
      const expectedActions = [
        {
