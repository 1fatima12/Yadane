...
export const FactureDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="electroYadaneVfApp.facture.delete.question">
        <Translate contentKey="electroYadaneVfApp.facture.delete.question" interpolate={{ id: factureEntity.id }}>
