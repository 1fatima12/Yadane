...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BONCOMMANDE_LIST actions', async () => {
    ...
    it('dispatches FETCH_BONCOMMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BONCOMMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BONCOMMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BONCOMMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BONCOMMANDE actions', async () => {
      const expectedActions = [
        {
