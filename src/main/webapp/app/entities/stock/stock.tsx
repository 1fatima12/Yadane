  ...
  return (
    <div>
      <h2 id="stock-heading" data-cy="StockHeading">
        <Translate contentKey="electroYadaneVfApp.stock.home.title">Stocks</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="electroYadaneVfApp.stock.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/stock/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="electroYadaneVfApp.stock.home.createLabel">Create new Stock</Translate>
          </Link>
        </div>
      </h2>
        ...
        {stockList && stockList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="electroYadaneVfApp.stock.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="electroYadaneVfApp.stock.qte">Qte</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="electroYadaneVfApp.stock.home.notFound">No Stocks found</Translate>
            </div>
          )
        )}
      </div>
