...
export const CommandeFournisseurDetail = (props: RouteComponentProps<{ id: string }>) => {
    ...
    <Row>
      <Col md="8">
        <h2 data-cy="commandeFournisseurDetailsHeading">
          <Translate contentKey="electroYadaneVfApp.commandeFournisseur.detail.title">CommandeFournisseur</Translate>
        </h2>
