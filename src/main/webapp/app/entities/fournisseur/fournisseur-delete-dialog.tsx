...
export const FournisseurDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="electroYadaneVfApp.fournisseur.delete.question">
        <Translate contentKey="electroYadaneVfApp.fournisseur.delete.question" interpolate={{ id: fournisseurEntity.id }}>
